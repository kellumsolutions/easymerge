...
<div class="wrap" id="easysync-admin">
    ...
    <div class="nav-tab-wrapper easysync-nav-tab-wrapper">
        <a class="nav-tab nav-tab-active" id="easysync-nav-tab-merge" href="<?php echo esc_url( admin_url( "tools.php?page=" . SyncEasy_Admin_Page::$handle . "#merge" ) ); ?>">Merge/Sync</a>
        <a class="nav-tab" id="easysync-nav-tab-license" href="<?php echo esc_url( admin_url( "tools.php?page=" . SyncEasy_Admin_Page::$handle . "#license" ) ); ?>">License</a>
        <a class="nav-tab" id="easysync-nav-tab-settings" href="<?php echo esc_url( admin_url( "tools.php?page=" . SyncEasy_Admin_Page::$handle . "#settings" ) ); ?>">Settings</a>
        <a class="nav-tab" id="easysync-nav-tab-advancedtools" href="<?php echo esc_url( admin_url( "tools.php?page=" . SyncEasy_Admin_Page::$handle . "#advanced-tools" ) ); ?>">Advanced Tools</a>
    </div>
